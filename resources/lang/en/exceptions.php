...
return [
	...
	"technologies" => [
	"already_exists" => "That Technology already exists. Please choose a different name.",
	"create_error" => "There was a problem creating this Technology. Please try again.",
	"delete_error" => "There was a problem deleting this Technology. Please try again.",
	"not_found" => "That Technology does not exist.",
	"update_error" => "There was a problem updating this Technology. Please try again.",
	],
	],
	"frontend" => [
	"auth" => [
