<!--Action Button-->
@if( Active::checkUriPattern( 'admin/projects' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.projects.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.projects.all' ) }}
            </a>
        </li>
        @permission( 'create-project' )
            <li>
                <a href="{{ route( 'admin.projects.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.projects.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
