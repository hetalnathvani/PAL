<!--Action Button-->
@if( Active::checkUriPattern( 'admin/technologies' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.technologies.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.technologies.all' ) }}
            </a>
        </li>
        @permission( 'create-technology' )
            <li>
                <a href="{{ route( 'admin.technologies.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.technologies.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
